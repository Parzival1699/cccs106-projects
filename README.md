...
- `week3_labs/main.py` - User Login Application

### Week 4 Labs - Contact book Application Enhancement
- `week3_labs/main.py` - Contact book Application
...
2. Virtual environment activated: `cccs106_env_atienza\Scripts\activate`
